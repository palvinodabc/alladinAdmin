...
const Navdata = () => {
  ...
  const menuItems = [
    ...
    {
      id: "subscriptionGraphs",
      label: "Subscription graphs",
      icon: "ri-bar-chart-2-line",
      link: "/SubscriptionGraph",
      click: function (e) {
        e.preventDefault();
        setIsSubscriptionGraphs(!isSubscriptionGraphs);
        setIscurrentState("Subscription graphs");
        updateIconSidebar(e);
      },
      stateVariables: isSubscriptionGraphs,
      //   subItems: [
      //     {
      //       id: "signIn",
      //       label: "Sign In",
...

    {
      ...
      click: function (e) {
        e.preventDefault();
        setIsSubscriptions(!isPaymentMethod);
        setIsPaymentMethod("Payment Method");
        updateIconSidebar(e);
      },
    },
