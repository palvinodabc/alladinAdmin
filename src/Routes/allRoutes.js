...
import FreeUsers from "../pages/userManagement/FreeUsers";
...
const authProtectedRoutes = [
  ...
  { path: "/premium", component: <PremiumUsers /> },
  { path: "/freeuser", component: <FreeUsers /> },
  // Dashboard->subscription
  { path: "/allSubscriptions", component: <AllSubscriptions /> },
  ...
  { path: "/SubscriptionGraph", component: <SbuscriptionGraph /> },
  //Chat
