...
// Admin login
export const adminLogin = (data) => api.create(url.ADMIN_LOGIN, data);
// get All-users table data
export const getAlluserData = () => api.get(url.GET_All_USER);
// get All-subscription table data
export const getAllSubcriptionsData = () => api.create(url.GET_All_SUBSCRIPTION);
export const createSubcriptionsData = (data) => api.create(url.CREATE_SUBSCRIPTION, data);
export const updateSubcriptionsData = (data) => api.put(`${url.UPDATE_SUBSCRIPTION}?id=${data.id}`, data.formData);
export const deleteSubcriptionsData = (id) => api.delete(`${url.DELETE_SUBSCRIPTION}?id=${id}`);
export const getCategoryData = () => api.get(url.GET_CATEGORY);
// Register Method
