...
// export const ADMIN_LOGIN = "/api/authpanel/login";
// get all user
// export const GET_All_USER = "/api/auth/profile";
export const GET_All_USER = "/api/auth/getAllUsers";
// get all subscription
export const GET_All_SUBSCRIPTION = "api/subscription/allsubscription";
export const CREATE_SUBSCRIPTION = "api/subscriptionMaster/addSubscriptionMaster";
export const UPDATE_SUBSCRIPTION = "api/subscriptionMaster/updateSubMaster";
export const DELETE_SUBSCRIPTION = "api/subscriptionMaster/deleteSubMaster";
export const GET_CATEGORY = "api/category/getCategory";
//PROFILE
