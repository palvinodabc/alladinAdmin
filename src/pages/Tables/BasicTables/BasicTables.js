          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-dark</code> class to set dark color table body and <code>table-success</code> class to set success color table
                    body respectively. use <code>table-</code> class with different color variation to set required table body color.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                          ...
                          <Table className="table-success table-striped table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>Nov 22, 2021</td>
                                <td>
                                  <i className="ri-checkbox-circle-line align-middle text-success"></i> Subscribed
                                </td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>Nov 10, 2021</td>
                                <td>
                                  <i className="ri-close-circle-line align-middle text-danger"></i> Unsubscribed
                                </td>
                                <td>
                                  <div className="hstack gap-3 flex-wrap">
                                    <Link to="#" className="link-success fs-15">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-hover</code> class to enable a hover state on table rows within a &lt;tbody&gt;.
                  </p>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="form-check form-switch">
                                    ...
                                    <Label className="form-check-label ms-2" htmlFor="SwitchCheck1">
                                      Yes/No
                                    </Label>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="form-check form-switch">
                                    ...
                                    <Label className="form-check-label ms-2" htmlFor="SwitchCheck2">
                                      Yes/No
                                    </Label>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="form-check form-switch">
                                    ...
                                    <Label className="form-check-label ms-2" htmlFor="SwitchCheck3">
                                      Yes/No
                                    </Label>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="form-check form-switch">
                                    ...
                                    <Label className="form-check-label ms-2" htmlFor="SwitchCheck4">
                                      Yes/No
                                    </Label>
                                  </div>
                                </td>
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-4">
                    Use <code>table-card</code> class to show card-based table within a &lt;tbody&gt;.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive table-card">
                      <Table className="align-middle table-nowrap mb-0">
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-active</code> class to highlight a table row or cell.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="align-middle table-nowrap mb-0">
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-bordered</code> class to show borders on all sides of the table and cells.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="table-bordered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Design syntax</td>
                            <td>
                              <span className="badge badge-soft-secondary">In Progress</span>
                            </td>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>border-</code> class with color variation class to set table border color.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-borderless</code> to set a table without borders.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
          ...
          <Row>
            <Col xl="6">
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-sm</code> class to create any table more compact by cutting all cell padding in half.
                  </p>
                      ...
                      <Table className="table-sm table-nowrap mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Implement extensions</td>
                            <td>
                              <span className="badge badge-soft-dark">Backlog</span>
                            </td>
                            <td>Maritza Blanda</td>
                          </tr>
                          <tr>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-light</code> or <code>table-dark</code> class to create &lt;thead&gt; appear light or dark.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="align-middle table-nowrap mb-0">
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Add <code>&lt;tbody&gt;</code> attribute to group footer content in an HTML table.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
            ...
            <Col xl={6}>
              <div className="card">
                ...
                <CardBody>
                  <p className="text-muted">
                    You can also put the <code>&lt;caption&gt;</code> attribute on the top of the table with <code>caption-top</code> class.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>table-</code> class with below-mentioned color variation class within &lt;tr&gt; to set color on table row.
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    inherit their alignment from <code>&lt;table&gt;</code> and are aligned to the the top by default. Use the vertical align classes
                      ...
                      <Table className="align-middle">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              This here is some placeholder text, intended to take up quite a bit of vertical space, to demonstrate how the vertical
                              alignment works in the preceding cells. Use the vertical align classes to re-align where needed. inherit their alignment
                              from and are aligned to the the top by default.
                            </td>
                          </tr>
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-responsive</code> class to make any table responsive across all viewports. Responsive tables allow tables to be
                    scrolled horizontally with ease.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="text-success">
                              <i className="ri-checkbox-circle-line fs-17 align-middle"></i> Paid
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="d-flex gap-2 align-items-center">
                                ...
                                <div className="flex-grow-1">Jackson Graham</div>
                              </div>
                            </td>
                            <td>Splashify</td>
                            <td>$270.60</td>
                          ...
                          <tr>
                            ...
                            <td className="text-primary">
                              <i className="ri-refresh-line fs-17 align-middle"></i> Refunded
                            </td>
                            <td>
                              <div className="d-flex gap-2 align-items-center">
                                <div className="flex-shrink-0">
                                ...
                                <div className="flex-grow-1">Lauren Trujillo</div>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="text-danger">
                              <i className="ri-close-circle-line fs-17 align-middle"></i> Cancel
                            </td>
                            <td>
                              <div className="d-flex gap-2 align-items-center">
                                <div className="flex-shrink-0">
