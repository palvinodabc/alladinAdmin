...
const ScrollVertical = () => {
  ...
  return <DataTable fixedHeader fixedHeaderScrollHeight="300px" columns={columns} data={data} />;
};
...
const AjaxDatatables = () => {
  ...
  return <DataTable columns={columns} pagination data={rows} progressPending={pending} />;
};
